...
export default function Produto80MilCortes({
  onComprar,
  jaComprou,
  checkoutProduct,
  setCheckoutProduct,
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <div className="mt-5 flex justify-center">
              <video
                controls
                playsInline
                className="w-full max-w-[360px] rounded-3xl border border-white/10 bg-black object-contain"
              >
                <source src="/videos/80mil-cortes.mp4" type="video/mp4" />
              </video>
            </div>
          </div>
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-black leading-tight">
              80 Mil Cortes Virais
            </h1>

            <p className="text-2xl text-green-400 font-black mt-6">R$ 9,50</p>

            <div className="mt-6 space-y-5 text-gray-300 text-lg leading-relaxed">
              <p>
                Pare de perder horas procurando conteúdo para postar. Receba uma biblioteca com mais de 80 mil cortes virais organizados por nichos.
              </p>

              <p>
                Ideal para TikTok, Instagram Reels, Facebook, Kwai, Shorts e outras plataformas de vídeos curtos.
              </p>

              <p>
                Perfeito para criar páginas de cortes, crescer perfis, gerar audiência e monetizar nas redes sociais.
              </p>

              <div className="rounded-2xl border border-green-500/30 bg-green-500/10 p-5">
                <p className="font-black text-green-400 mb-2">🚀 Pronto para usar</p>
                <p>Conteúdos organizados por nichos, com acesso liberado automaticamente após a compra.</p>
              </div>
            </div>

            <div className="mt-8 space-y-4">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Mais de 80 mil cortes</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Diversos nichos</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Conteúdo organizado</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Ideal para viralizar e monetizar</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Entrega automática em Minhas Compras</div>
            </div>
            ...
            <div className="mt-8 rounded-3xl border border-green-500/30 bg-green-500/10 p-5">
              ...
              <p className="text-gray-300">
                Após a aprovação do pagamento, o acesso ficará disponível automaticamente em Minhas Compras.
              </p>
            </div>

            {avisoCarrinho && (
              <div className="mt-5 rounded-2xl border border-green-500/30 bg-green-500/10 p-4 text-green-300 font-bold">
                {avisoCarrinho}
              </div>
            )}
              ...
              <button
                onClick={() => {
                  ...
                  const jaTem = carrinhoAtual.some(
                    (item) => item.name === produto80Mil.name
                  );

                  if (!jaTem) {
                    localStorage.setItem(
                      "carrinho",
                      JSON.stringify([...carrinhoAtual, produto80Mil])
                    );
                  }

                  setAvisoCarrinho("✅ 80 Mil Cortes Virais adicionado ao carrinho! Volte para a loja e abra o carrinho para finalizar.");
                }}
      ...
      {checkoutProduct && checkoutProduct.name === "80 Mil Cortes Virais" && (
        <div className="fixed inset-0 z-[999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
