...
export default function ProdutoPainelSMM({
  user,
  loginOpen,
  setLoginOpen,
  onComprar,
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            <img
              src="/produtos/painel-smm.png"
              className="w-full rounded-3xl border border-pink-500/30"
              alt="Painel SMM"
            />

            <div className="mt-5">
              <p className="text-center text-pink-400 font-black mb-3">
              ...
              <video
                controls
                playsInline
                className="block md:hidden w-full max-w-[280px] mx-auto aspect-[9/16] rounded-3xl border border-white/10 bg-black object-cover"
              >
                <source src="/videos/painel-smm-mobile.mp4" type="video/mp4" />
              </video>
  ...
  >
    <source src="/videos/painel-smm-mobile.mp4" type="video/mp4" />
              ...
              <video
                controls
                playsInline
                className="hidden md:block w-full rounded-3xl border border-white/10 bg-black"
              >
                <source src="/videos/painel-smm-pc.mp4" type="video/mp4" />
              </video>
            </div>
          </div>

          <div>
            <span className="bg-pink-600 px-4 py-2 rounded-xl font-black inline-block mb-4">
              PAINEL SMM
            </span>

            <h1 className="text-4xl md:text-6xl font-black leading-tight">
              Painel SMM para vender seguidores, curtidas e visualizações
            </h1>

            <p className="text-2xl text-green-400 font-black mt-6">R$ 25,00</p>

            <div className="mt-6 space-y-5 text-gray-300 text-lg leading-relaxed">
              <p>
                O Painel SMM é uma ferramenta para você vender seguidores, curtidas,
                visualizações, comentários, compartilhamentos e vários outros serviços digitais.
              </p>

              <p>
                Você pode trabalhar com Instagram, TikTok, Facebook, YouTube, Kwai
                e outras plataformas, criando suas próprias tabelas e vendendo com lucro.
              </p>

              <p>
                É ideal para quem quer começar uma renda online oferecendo serviços de engajamento
                para clientes, lojas, influenciadores e perfis comerciais.
              </p>

              <div className="rounded-2xl border border-pink-500/30 bg-pink-500/10 p-5">
                <p className="font-black text-pink-400 mb-2">💸 Crie sua própria tabela</p>
                <p>
                  Você escolhe seus preços, monta suas ofertas e vende os serviços do seu jeito.
                </p>
              </div>
            </div>

            <div className="mt-8 space-y-4">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Venda seguidores, curtidas e views</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Instagram, TikTok, YouTube, Facebook e Kwai</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Funciona no celular, computador, Android, iOS e emulador</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Ideal para revender serviços digitais</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">✅ Acesso liberado automaticamente após a compra</div>
            </div>
            ...
            <div className="mt-8 rounded-3xl border border-green-500/30 bg-green-500/10 p-5">
              ...
              <p className="text-gray-300">
                Após a aprovação do pagamento, o acesso ao painel ficará disponível automaticamente na área “Minhas Compras”.
              </p>
            </div>
              ...
              <button
                onClick={() => {
                  ...
                  const jaTem = carrinhoAtual.some(
                    (item) => item.name === produtoPainel.name
                  );

                  if (!jaTem) {
                    localStorage.setItem(
                      "carrinho",
                      JSON.stringify([...carrinhoAtual, produtoPainel])
                    );
                  }

                  setAvisoCarrinho("✅ Painel SMM adicionado ao carrinho! Volte para a loja e abra o carrinho quando quiser finalizar.");
                }}
      ...
      {checkoutProduct && checkoutProduct.name === "Painel SMM" && (
        <div className="fixed inset-0 z-[999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md max-h-[90vh] overflow-y-auto rounded-3xl border border-green-500/30 bg-[#0b0b0d] p-6">
            ...
            <p className="text-green-400 font-black text-xl mb-4">Painel SMM — R$ 25,00</p>
